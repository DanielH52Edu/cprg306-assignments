    ...
    <main className={'flex flex-col items-center justify-center'}>
      <h1 className={'text-2xl m-6'}>CPRG 306: Web Development 2 - Assignments</h1>
        <ul className="text-green-400">
            ...
            <li><Link href={'week-9'} className="hover:underline hover:text-green-200">Week 9</Link></li>
            <li><Link href={'week-10'} className="hover:underline hover:text-green-200">Week 10</Link></li>
        </ul>
    </main>
  );
}
